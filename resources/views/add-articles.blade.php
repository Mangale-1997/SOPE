...
<!-- menu profile quick info -->
  ...
  <!-- page content -->
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg">Add Articles</button>
...
<!-- css start -->
   ...
   <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> View Articles <small></small></h2>
    ...
    <div class="modal-content">
     ...
     <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype = "multipart/form-data" method ="post" action = "{{route('store.news')}}">
                                          @csrf
                                           ...
                                           <label class="col-form-label col-md-3 col-sm-3 label-align" for="content2">Articles  Title <span class="required">*</span>
											</label>
                                           <div class="col-md-6 col-sm-6 ">
											 <input type="text" id="news_title" name="articles_title" required="required" class="form-control">
											</div>
                                            ...
                                            <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="content2">Document(Pdf Format)<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="document" name="document" required="required" class="form-control">
											</div>
										    </div>
										   <div class="item form-group">
