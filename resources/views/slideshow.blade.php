                      ...
                      <tbody>
                        @foreach($data as $datas)
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">{{$datas->content1}}</td>
                            <td class=" ">{{$datas->content2}}</td>
                            <td class=" ">{{$datas->content3}}</td>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     ...
     <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype = "multipart/form-data" method ="post" action = "{{route('store.corousel')}}">
                                          @csrf
