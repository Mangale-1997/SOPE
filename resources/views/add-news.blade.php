        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-paw"></i> <span>Add News</span></a>
            </div>
...
<!-- menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{route('dashboard')}}"><i class="fa fa-home"></i> Home <span class=""></span></a>
  ...
  <!-- page content -->
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg">Add News</button>
                      ...
                      <tbody>
                        @foreach($data as $datas)
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">{{$datas->news_title}}</td>
                            <td class=" ">{{$datas->news_description}}</td>
                            <td class=" ">{{$datas->news_category}}</td>
                            <td class=" "><img src = "{{ ($datas->photo)}}" height = 50px width = 50px></td>
                            <td class=" ">
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     ...
     <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype = "multipart/form-data" method ="post" action = "{{route('store.news')}}">
                                          @csrf
                                           <div class="item form-group">
                                           <label class="col-form-label col-md-3 col-sm-3 label-align" for="content2">News Title <span class="required">*</span>
											</label>
                                           <div class="col-md-6 col-sm-6 ">
											 <input type="text" id="news_title" name="news_title" required="required" class="form-control">
											</div>
                                            ...
                                            <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">News Category*</label>
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name = "news_category" required="required" type="text">
										    ...
										    <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="content2">News Description<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											 <input type="text" id="news_description" name="news_description" required="required" class="form-control">
											</div>
										    </div>
                                            <div class="item form-group">
