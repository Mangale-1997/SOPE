                      ...
                      <tbody>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo e($datas->news_title); ?></td>
                            <td class=" "><?php echo e($datas->news_description); ?></td>
                            <td class=" "><?php echo e($datas->news_category); ?></td>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     ...
     <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype = "multipart/form-data" method ="post" action = "<?php echo e(route('store.news')); ?>">
                                          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\SoPE\resources\views/add-news.blade.php ENDPATH**/ ?>