        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-paw"></i> <span>View  Comment</span></a>
            </div>
...
<!-- css start -->
   ...
   <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> View Comments <small></small></h2>
                      ...
                      <tbody>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo e($datas->created_at); ?></td>
                            <td class=" "><?php echo e($datas->name); ?></td>
                            <td class=" "><?php echo e($datas->email); ?></td>
                            <td class=" "><?php echo e($datas->subject); ?></td>
                            <td class=" "><?php echo e($datas->comment); ?></td>
...
<?php /**PATH C:\xampp\htdocs\SoPE\resources\views/add-comment.blade.php ENDPATH**/ ?>