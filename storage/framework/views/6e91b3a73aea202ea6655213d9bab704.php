            ...
            <div class="container py-5">
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype = "multipart/form-data" method ="post" action = "<?php echo e(route('store-comment')); ?>">
                            <?php echo csrf_field(); ?>
                        <div class="row g-4">
...
<?php /**PATH C:\xampp\htdocs\SoPE\resources\views/Contactus.blade.php ENDPATH**/ ?>